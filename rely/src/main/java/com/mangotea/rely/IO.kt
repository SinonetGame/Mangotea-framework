...
import com.mangotea.rely.io.CacheObejct
import com.mangotea.rely.io.DiskCacheIO
import com.mangotea.rely.io.DiskDataIO
import com.mangotea.rely.io.LruCacheIO
import com.mangotea.rely.keeps.io.BasicType
...
fun Context.ram(key: String, value: Parcelable, shelfLife: Long = -1L) =
    ram.put(this, key, value, shelfLife)

fun Context.ram2(key: String, value: Serializable, shelfLife: Long = -1L) =
    ram2.put(this, key, value, shelfLife)
...
fun <V : Serializable> Context.push(key: String, value: V): Boolean =
    DiskDataIO.push(this, key, value)
...
fun <V : Serializable> Context.pump(key: String, value: V): Boolean =
    DiskDataIO.pump(this, key, value)

inline fun <V : Serializable> Context.pump(key: String, predicate: ((V) -> Boolean)) =
    DiskDataIO.pumpBy(this, key, predicate)
