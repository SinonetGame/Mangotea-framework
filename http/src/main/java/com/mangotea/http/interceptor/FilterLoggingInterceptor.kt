...
class FilterLoggingInterceptor @JvmOverloads constructor(
        private val logTag: String = "OkHttpClient.okhttp",
        private val logger: Logger = Logger.create(logTag),
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        try {
            ...
            if (e.message?.contains("No host available") != true)
