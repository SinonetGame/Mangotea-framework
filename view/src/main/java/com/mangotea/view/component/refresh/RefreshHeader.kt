...
@Suppress("ClassName")
open class _RefreshHeader @JvmOverloads constructor(
    context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0
) : _InternalAbstract(context, attrs, defStyleAttr), RefreshHeader {
    init {
    ...
    fun finished(block: (RefreshLayout, Boolean) -> Unit): _RefreshHeader {
        _onFinish = block
        return this
    }


    fun initialized(block: (kernel: RefreshKernel, height: Int, maxDragHeight: Int) -> Unit): _RefreshHeader {
        _initialized = block
        return this
    }

    fun startAnimator(block: (kernel: RefreshLayout, height: Int, maxDragHeight: Int) -> Unit): _RefreshHeader {
        _startAnimator = block
        return this
    }

    fun moving(block: (isDragging: Boolean, percent: Float, offset: Int, height: Int, maxDragHeight: Int) -> Unit): _RefreshHeader {
        _moving = block
        return this
    }

    fun stateChanged(block: (RefreshLayout, RefreshState, RefreshState) -> Unit): _RefreshHeader {
